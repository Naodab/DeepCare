"""
URL configuration for deepcare_server project.
...
from .views import MyEmailTokenObtainPairView
...
urlpatterns = [
    ...
    path('api/token/', MyEmailTokenObtainPairView.as_view(), name='token_obtain_pair'),
