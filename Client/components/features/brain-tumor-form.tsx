...
import { analyzeBrainMRI } from "@/lib/api-actions"

export function BrainTumorForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "MRI image has been analyzed successfully.",
      })
    } catch (error) {
      toast({
        variant: "destructive",
            ...
            <div className="flex flex-col items-center justify-center space-y-4">
              {!preview ? (
                <div className="flex flex-col items-center justify-center border-2 border-dashed border-muted-foreground/25 rounded-lg p-12 text-center">
                  ...
                  <div className="mb-2 text-lg font-medium">Drop your MRI image here or click to browse</div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-2">
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      result.prediction === "Tumor Detected" ? "text-red-500 font-bold" : "text-green-500 font-bold"
                    }
                  >
                    {result.prediction}
                  </span>
